...
import { useLpTokenPriceV2, usePriceHobiEth, usePriceSutekuEth, useUniPriceSodatsuEth } from 'state/hooks'
...
const AprRow: React.FC<AprRowProps> = ({
  ...
  const sodatsuPrice = useUniPriceSodatsuEth()
  ...
  const earningTokenPrice = sodatsuPrice
